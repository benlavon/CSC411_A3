...
def error_rate(predictions, labels, final):
  ...
  if final == 1:
      print('Writing predicted test labels out.')
      predict = {}
      predict['test'] = predictions
      sp.savemat('predictions.mat', predict)
    ...
    for step in xrange(int(num_epochs * train_size) // BATCH_SIZE):
      ...
      if step % EVAL_FREQUENCY == 0:
        ...
        print('Validation error: %.1f%%' % error_rate(
            eval_in_batches(validation_data, sess), validation_labels, 0))
        sys.stdout.flush()
    # Finally print the result!
    test_error = error_rate(eval_in_batches(test_data, sess), test_labels, 1)
